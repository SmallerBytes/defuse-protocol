...
export function build({ view, send }) {
  ...
  armGroup.position.set(-0.105, 0, -0.02);
  ...
  armLight.position.set(0, 0.018, -0.045);
  ...
  armLabel.position.set(0, 0.0165, 0.046);
  ...
  knob.add(notch);
  knob.position.set(-0.015, 0.011, 0.005);
  ...
  fuzeBtn.position.set(0.075, 0.009, -0.045);
  ...
  for (let i = 0; i < 3; i++) {
    ...
    wheel.position.set(-0.098 + i * 0.033, 0.012, 0.055);
  ...
  codeLabel.position.set(-0.065, 0.0005, 0.083);
  group.add(codeLabel);
  ...
  guard.position.set(0.085, 0.008, 0.058);
  group.add(guard);
  ...
  pickle.position.set(0.085, 0.012, 0.058);
